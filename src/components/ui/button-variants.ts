 ...
 * Button class recipe.
 *
 * Kept in its own module rather than beside the component: a file that exports both a
 * component and a plain value cannot be hot-reloaded by React Fast Refresh, which
 * silently degrades every edit of this file into a full page reload during design work.
 * Consumers that need the recipe (to style a link or a Slot as a button) import it from
 * here; consumers that need the component import `Button` from `./button`.
 */
